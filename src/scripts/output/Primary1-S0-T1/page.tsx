      ...
      <main className="px-4 py-8 max-w-5xl mx-auto">
        ...
        <div className="bg-white/70 backdrop-blur-sm border border-teal-100 rounded-xl p-6 mb-8">
          <p className="text-slate-700 leading-relaxed">
            Living things grow, reproduce, and need food and water to survive, while non-living things do not. Examples include plants and animals as living things, and rocks and toys as non-living things.
          </p>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <SectionCard icon={<Lightbulb className="h-5 w-5 text-amber-600" />} title="Interactive Activities" color="amber">
            <ul className="space-y-3 list-disc pl-5 marker:text-amber-500">
              ...
              <li>Observe and document growth of plants in the classroom</li>
              <li>Create a collage of living and non-living things found in nature</li>
              <li>Role-play animal movements and plant growth</li>
            </ul>
          </SectionCard>

          <SectionCard icon={<CheckSquare className="h-5 w-5 text-sky-600" />} title="Learning Outcomes" color="sky">
            <p className="text-slate-700 leading-relaxed">
              Students will be able to identify living and non-living things and explain their basic differences.
            </p>
          </SectionCard>
          ...
          <SectionCard icon={<Heart className="h-5 w-5 text-rose-600" />} title="Values & Attitudes" color="rose">
            <ul className="space-y-3 list-disc pl-5 marker:text-rose-500">
              ...
              <li>Responsibility in caring for plants and animals</li>
            </ul>
          </SectionCard>
          ...
          <SectionCard icon={<Microscope className="h-5 w-5 text-indigo-600" />} title="STSE Connections" color="indigo">
            <ul className="space-y-3 list-disc pl-5 marker:text-indigo-500">
              ...
              <li>Recognizing human impact on living organisms</li>
            </ul>
          </SectionCard>
        </div>
